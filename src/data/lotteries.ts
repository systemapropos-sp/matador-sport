...
export const lotteries: Lottery[] = [
  ...
  { id: 'la-primera', name: 'LA PRIMERA', schedule: '12:00 PM', type: 'regular', color: '#F48FB1' },
  { id: 'lotedom', name: 'LOTEDOM', schedule: '1:30 PM', type: 'regular', color: '#81D4FA' },
  { id: 'la-suerte', name: 'LA SUERTE', schedule: '12:30 PM', type: 'regular', color: '#A5D6A7' },
  { id: 'king-lottery-am', name: 'King Lottery AM', schedule: '12:30 PM', type: 'regular', color: '#FFD54F' },
  ...
  { id: 'gana-mas', name: 'GANA MAS', schedule: '6:00 PM', type: 'regular', color: '#FF8A65' },
  ...
  { id: 'la-suerte-6pm', name: 'LA SUERTE 6PM', schedule: '6:00 PM', type: 'regular', color: '#A5D6A7' },
  { id: 'king-lottery-pm', name: 'King Lottery PM', schedule: '7:30 PM', type: 'regular', color: '#FFD54F' },
  { id: 'loteca', name: 'LOTECA', schedule: '7:00 PM', type: 'regular', color: '#81C784' },
  { id: 'la-primera-7pm', name: 'LA PRIMERA 7PM', schedule: '7:00 PM', type: 'regular', color: '#F48FB1' },
