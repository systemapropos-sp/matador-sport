...
export const lotteries: Lottery[] = [
  ...
  { id: 'la-primera', name: 'LA PRIMERA', schedule: '12:00 PM', type: 'regular', color: '#F06292' },
  { id: 'lotedom', name: 'LOTEDOM', schedule: '1:30 PM', type: 'regular', color: '#4FC3F7' },
  { id: 'la-suerte', name: 'LA SUERTE', schedule: '12:30 PM', type: 'regular', color: '#AED581' },
  { id: 'king-lottery-am', name: 'King Lottery AM', schedule: '12:30 PM', type: 'regular', color: '#FFD700' },
  { id: 'quiniela-real', name: 'QUINIELA REAL', schedule: '2:00 PM', type: 'regular', color: '#CE93D8' },
  { id: 'anguila-1pm', name: 'Anguila 1PM', schedule: '1:00 PM', type: 'regular', color: '#FFD54F' },
  { id: 'gana-mas', name: 'GANA MAS', schedule: '6:00 PM', type: 'regular', color: '#FF7043' },
  ...
  { id: 'king-lottery-pm', name: 'King Lottery PM', schedule: '7:30 PM', type: 'regular', color: '#FFD700' },
  { id: 'loteca', name: 'LOTECA', schedule: '7:00 PM', type: 'regular', color: '#AB47BC' },
  { id: 'la-primera-7pm', name: 'LA PRIMERA 7PM', schedule: '7:00 PM', type: 'regular', color: '#F06292' },
  { id: 'nacional', name: 'NACIONAL', schedule: '2:00 PM', type: 'regular', color: '#4CAF50' },
  { id: 'quiniela-pale', name: 'QUINIELA PALE', schedule: '2:30 PM', type: 'regular', color: '#CE93D8' },
  ...
  { id: 'super-pale-ny-ganamas', name: 'SUPER PALE NY-GANA MAS', schedule: '10:30 PM', type: 'super-pale', color: '#FF8A65' },
  { id: 'super-pale-nacional-qp', name: 'SUPER PALE NACIONAL-QP', schedule: '2:30 PM', type: 'super-pale', color: '#FF8A65' },
  { id: 'super-pale-ny-nacional', name: 'SUPER PALE NY-NACIONAL', schedule: '10:30 PM', type: 'super-pale', color: '#FF8A65' },
];
